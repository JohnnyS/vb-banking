...
-- You dont need to add ATM or bank coords in here only thing in here used is the bank coords for the blips. Create a new qtarget boxzone for a new bank
...
Config.Zonas = {
    ...
    ["atms"] = {
		...
		{name="ATM", id=277, x=265.29, y=-986.3, z=29.37},
        {name="ATM", id=277, x=315.17, y=-593.69, z=43.28},
        {name="ATM", id=277, x=-1430.99, y=-263.22, z=46.26},
        {name="ATM", id=277, x=2683.08, y=3286.56, z=55.25},
        {name="ATM", id=277, x=166.1, y=6634.87, z=31.71},
        {name="ATM", id=277, x=1116, y=219.95, z=-49.44}, --CASINO
    }   
}